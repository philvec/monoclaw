...
_SCHEMA_INSTRUCTIONS = (
    ...
    "Unless the user explicitly asked for those, leave them out. Commentary about what you are doing "
    "is allowed only when short and meaningful; prefer none. "
    ...
    "INTERIM MESSAGES: text you write alongside tool calls is delivered to the user immediately, before "
    "those tools run. Use it only when it genuinely helps (e.g. a slow lookup is coming), keep it to one "
    "short line, and never put the final answer there — that belongs in message.\n"
