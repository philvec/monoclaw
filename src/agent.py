...
_SCHEMA_INSTRUCTIONS = (
    ...
    "INTERIM LINE — REQUIRED BEFORE EVERY TOOL CALL: in the SAME response as your tool calls, write "
    "exactly ONE short line of plain text saying what you are doing (e.g. 'Sprawdzam historię świateł…'). "
    "It is delivered to the user immediately, before the tools run. Exactly one line, never two, never the "
    "final answer — and on every tool-calling response, not just the slow ones. Do NOT use send_message "
    "for this; it is fan-out only and is refused for the input channel.\n"
